...
# coq_makefile BoehmTactics.v Changeable.v DesignStructure.v Example_Car.v Example_Car_Changeable.v Example_Parnas.v Example_Parnas_Changeable.v Example_Parnas_Functional_Decomposition.v Example_Parnas_Information_Hiding.v LibTactics.v Quality.v System.v Value.v 
#
