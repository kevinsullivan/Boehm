...
# coq_makefile BoehmTactics.v Changeable.v DesignStructure.v Example_Car.v Example_Car_Changeable.v Example_Parnas_Information_Hiding.v Example_Parnas_Information_Hiding_Changeable.v LibTactics.v ParnasInformationHiding.v Quality.v System.v Value.v 
#
