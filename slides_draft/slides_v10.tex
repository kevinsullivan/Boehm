...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Class} \coqdocrecord{Satisfactory} (\coqdocvar{System}: \coqdockw{Set}) (\coqdocvar{Stakeholder}: \coqdockw{Set}) (\coqdocvar{Context}: \coqdockw{Set}) (\coqdocvar{Phase}: \coqdockw{Set}):= \{\coqdoceol
\coqdocindent{3.00em}
\coqdocvar{sys}: \coqdocvar{System}\coqdoceol
\coqdocnoindent
\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{physicalCapability} : \coqdocvar{System} \ensuremath{\rightarrow} \coqdocvar{Stakeholder} \ensuremath{\rightarrow} \coqdocvar{Context} \ensuremath{\rightarrow} \coqdocvar{Phase} \ensuremath{\rightarrow} \coqdockw{Prop}\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{cyberCapability} : \coqdocvar{System} \ensuremath{\rightarrow} \coqdocvar{Stakeholder} \ensuremath{\rightarrow} \coqdocvar{Context} \ensuremath{\rightarrow} \coqdocvar{Phase} \ensuremath{\rightarrow} \coqdockw{Prop}\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{humanUsability} : \coqdocvar{System} \ensuremath{\rightarrow} \coqdocvar{Stakeholder} \ensuremath{\rightarrow} \coqdocvar{Context} \ensuremath{\rightarrow} \coqdocvar{Phase} \ensuremath{\rightarrow} \coqdockw{Prop}\coqdoceol
\coqdocnoindent
\coqdocindent{2.00em}
\coqdockw{......}\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{exchangeability}: \coqdocvar{System} \ensuremath{\rightarrow} \coqdocvar{Stakeholder} \ensuremath{\rightarrow} \coqdocvar{Context} \ensuremath{\rightarrow} \coqdocvar{Phase} \ensuremath{\rightarrow} \coqdockw{Prop} \coqdoceol
\coqdocindent{2.00em}
\coqdockw{......}\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{affordable}: \coqdocinductive{Affordable} \coqdocvar{System} \coqdocvar{Stakeholder} \coqdocvar{Context} \coqdocvar{Phase} \coqdocvar{sys}\coqdoceol
\coqdocindent{11.00em}
\coqdocmethod{physicalCapability} \coqdocmethod{cyberCapability} \coqdocmethod{humanUsability} \coqdocmethod{speed} \coqdocmethod{endurability}\coqdoceol
\coqdocindent{11.00em}
 \coqdocmethod{maneuverability} \coqdocmethod{accuracy} \coqdocmethod{impact} \coqdocmethod{scalability} \coqdocmethod{versability} \coqdocmethod{interoperability}\coqdocmethod{cost}                           \coqdoceol
\coqdocindent{11.00em}
 \coqdocmethod{duration} \coqdocmethod{keyPersonnel} \coqdocmethod{otherScareResources} \coqdocmethod{manufacturability} \coqdocmethod{sustainability}\coqdoceol
\coqdocindent{2.00em}
; \coqdocprojection{resilient}: \coqdocinductive{Resilient} \coqdocvar{System} \coqdocvar{Stakeholder} \coqdocvar{Context} \coqdocvar{Phase} \coqdocvar{sys}\coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{security} \coqdocmethod{safety} \coqdocmethod{reliability} \coqdocmethod{maintainability} \coqdocvar{availability} \coqdocmethod{survivability} \coqdocmethod{robustness}\coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{modifiability} \coqdocmethod{tailorability} \coqdocmethod{adaptability} \coqdocmethod{valueRobustness} \coqdocmethod{valueSurvivability} \coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{ross\_robustness} \coqdocmethod{classicalPassiveRobustness} \coqdocmethod{ross\_survivability} \coqdocmethod{evolvability}  \coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{ross\_adaptability} \coqdocmethod{ross\_flexibility} \coqdocmethod{ross\_scalability} \coqdocmethod{ross\_modifiability} \coqdocmethod{extensibility} \coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{agility} \coqdocmethod{reactivity} \coqdocmethod{formReconfigurability} \coqdocmethod{operationalReconfigurability}  \coqdoceol
\coqdocindent{9.70em}
\coqdocmethod{functionalVersatility} \coqdocmethod{operationalVersatility} \coqdocmethod{exchangeability} \coqdoceol
\coqdocnoindent
\coqdoceol
\coqdocnoindent
\}.\coqdoceol
